...
class GST(nn.Module):
    ...
    def __init__(self, ref_enc_filters, n_mels, emb_size, token_num, num_heads):
        ...
        super().__init__()
        self.encoder = ReferenceEncoder(ref_enc_filters, n_mels, emb_size)
        self.stl = STL(token_num, emb_size, num_heads)
...
class ReferenceEncoder(nn.Module):
    ...
    def __init__(self, ref_enc_filters, n_mels, emb_size):
        super().__init__()
        self.n_mels = n_mels
...
class STL(nn.Module):
    ...
    def __init__(self, token_num, emb_size, num_heads):

        super().__init__()
        self.embed = nn.Parameter(torch.FloatTensor(token_num, emb_size // num_heads))
        d_q = emb_size // 2
